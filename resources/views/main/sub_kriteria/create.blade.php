        ...
        <div class="col-lg-12 mx-auto">
            <div class="card">
                <div class="card-header bg-transparent py-3 d-flex align-items-center">
                    ...
                    <h5 class="card-title mb-0">Tambah Sub Kriteria Baru</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('sub.kriteria.store') }}" method="POST" id="form">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                    ...
                                    id="nama" name="nama" placeholder="Sangat Baik" value="{{ old('nama') }}">
                                @error('nama')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                    ...
                                    id="bobot" name="bobot" placeholder="5" value="{{ old('bobot') }}">
                                @error('bobot')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
