        ...
        <div class="col-lg-12 mx-auto">
            <div class="card">
                <div class="card-header bg-transparent py-3 d-flex align-items-center">
                    ...
                    <h5 class="card-title mb-0">Ubah Wisata</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('wisata.update', $wisata->id) }}" method="POST" id="form"
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                    ...
                                    id="nama" name="nama" placeholder="Pantai" value="{{ $wisata->nama }}">
                                @error('nama')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <textarea class="form-control border-start-0 ps-0 @error('deskripsi') is-invalid @enderror" rows="5"
                                    id="deskripsi" name="deskripsi" placeholder="Deskripsi tempat wisata">{{ $wisata->deskripsi }}</textarea>
                                @error('deskripsi')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                    ...
                                    id="alamat" name="alamat" placeholder="Pantai" value="{{ $wisata->alamat }}">
                                @error('alamat')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="row mt-4">
                                <div class="col-md-4 mx-auto">
                                    <label for="currentImage" class="form-label">Foto saat ini</label>
                                    <img src="{{ $wisata->foto ? asset('storage/' . $wisata->foto) : asset('assets/images/image_not_available.webp') }}"
                                        alt="current image" style="max-width: 200px;">
                                </div>
                                <div class="col-md-4 mx-auto">
                                    <label for="imagePreview" class="form-label">Foto Baru</label>
                                    <div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <select class="form-select border-start-0 ps-0 @error('is_active') is-invalid @enderror"
                                    id="is_active" name="is_active">
                                    <option value="1" {{ $wisata->is_active == 1 ? 'selected' : '' }}>Active</option>
                                    <option value="0" {{ $wisata->is_active == 0 ? 'selected' : '' }}>Inactive</option>
                                </select>
                                @error('is_active')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
