        ...
        <div class="col-lg-12 mx-auto">
            <div class="card">
                <div class="card-header bg-transparent py-3 d-flex align-items-center">
                    ...
                    <h5 class="card-title mb-0">Tambah Kriteria Baru</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('kriteria.store') }}" method="POST" id="form">
                        @csrf
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                    ...
                                    id="kode" name="kode" placeholder="C1" value="{{ old('kode') }}">
                                @error('kode')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                    ...
                                    id="nama" name="nama" placeholder="Harga Tiket" value="{{ old('nama') }}">
                                @error('nama')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <select name="sifat" id="sifat"
                                    ...
                                    <option value="benefit" {{ old('sifat') == 'benefit' ? 'selected' : '' }}>Benefit
                                    </option>
                                </select>
                                <span></span>
                                @error('sifat')
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group">
                                ...
                                <input type="text"
                                    ...
                                    id="bobot" name="bobot" placeholder="10" value="{{ old('bobot') }}">
                                @error('bobot')
                                    <div class="invalid-feedback d-block">{{ $message }}</div>
                                @enderror
                            </div>
