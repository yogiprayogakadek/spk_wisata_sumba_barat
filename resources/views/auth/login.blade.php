...
<body>
    ...
    <div class="login-left">
        <div class="carousel-bg" id="loginCarousel">
        ...
        <div class="carousel-dots" id="loginDots">
    ...
    <script>
        (function() {
            const slides = document.querySelectorAll('#loginCarousel .carousel-slide');
            const dots   = document.querySelectorAll('#loginDots .carousel-dot');
            let current  = 0;
